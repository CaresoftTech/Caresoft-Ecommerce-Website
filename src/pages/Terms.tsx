    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-card rounded-2xl shadow-xl p-8 space-y-6">
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-vibrant-purple">1. Agreement to Terms</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-vibrant-pink">2. Use License</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-vibrant-blue">3. Product Information</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-vibrant-teal">4. Pricing and Payment</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-vibrant-orange">5. Order Acceptance</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-vibrant-purple">6. Account Responsibilities</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-vibrant-pink">7. Limitation of Liability</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-vibrant-blue">8. Changes to Terms</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-vibrant-teal">9. Contact Information</h2>
            <p className="text-muted-foreground">
