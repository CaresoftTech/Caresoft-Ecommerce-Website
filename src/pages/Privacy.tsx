    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-card rounded-2xl shadow-xl p-8 space-y-6">
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-[#3c9edc]">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-[#3c9edc]">2. How We Use Your Information</h2>
            <p className="text-muted-foreground mb-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-[#3c9edc]">3. Information Sharing</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-[#3c9edc]">4. Data Security</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-[#3c9edc]">5. Cookies and Tracking</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-[#3c9edc]">6. Your Rights</h2>
            <p className="text-muted-foreground mb-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-[#3c9edc]">7. Children's Privacy</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-[#3c9edc]">8. Changes to Privacy Policy</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-[#3c9edc]">9. Contact Us</h2>
            <p className="text-muted-foreground">
