...
export const sampleOrders: Order[] = [
  {
    ...
    customer_id: '1',
    product_names: 'Gaming Laptop Pro X1',
    total_amount: 1599,
    status: 'Delivered',
  ...
  },
  {
    ...
    customer_id: '2',
    product_names:
      'Wireless Noise-Cancelling Headphones, Ultra-Wide Monitor 34"',
    total_amount: 778,
    status: 'Shipped',
  ...
  },
  {
    ...
    customer_id: '3',
    product_names:
      'Mechanical Gaming Keyboard RGB, Wireless Gaming Mouse',
    total_amount: 178,
    status: 'Processing',
  ...
  },
  {
    ...
    customer_id: '4',
    product_names: 'Smartphone Pro Max 256GB',
    total_amount: 1099,
    status: 'Pending',
    ...
    items: [
      {
        id: '4-1',
        product_name: 'Smartphone Pro Max 256GB',
        product_image:
          'https://images.unsplash.com/photo-1592286927505-c0cdd2eb1f14?w=500',
        quantity: 1,
        price: 1099,
      },
    ],
  },
  {
    ...
    customer_id: '5',
    product_names: 'Portable SSD 2TB, Webcam 4K Pro',
    total_amount: 408,
    status: 'Cancelled',
